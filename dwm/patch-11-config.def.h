--- config.def.h.orig	2025-01-23 19:36:54.294750000 +0300
+++ config.def.h	2025-01-23 19:37:09.920388000 +0300
@@ -11,22 +11,26 @@
...
+	{ MODKEY|ShiftMask,             XK_Return, spawn,          SHCMD("/bin/sh /home/yusuf/.local/bin/stmux") },
...
+	{ ClkStatusText,        0,              Button2,        spawn,          SHCMD("/bin/sh /home/yusuf/.local/bin/stmux") },
